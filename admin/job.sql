...
SELECT * FROM malacca_user;
SELECT * FROM malacca_appInfo;
SELECT * FROM malacca_appCategory;
SELECT * FROM malacca_appPicInfo;
SELECT * FROM malacca_appIconInfo;
SELECT * FROM malacca_appIconSize;